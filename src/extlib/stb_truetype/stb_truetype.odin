package linux_stb_truetype

import c "core:c"
import stbrp "vendor:stb/rect_pack"

// Only needed on linux
when ODIN_OS == .Windows { #panic("Trying to import stb_truetype in linux_extlib from Windows") }
when ODIN_OS == .Linux   { foreign import stbtt "./stb_truetype.a" }
when ODIN_OS == .Darwin  { #panic("Trying to import stb_truetype in linux_extlib from Darwin") }
